public class Tea2 
{
    ...
    public static void main (String args[])
    {
        ...
        System.out.print("Our first tea is "+ t2.teaName+ " sells for "+t2.teaPrice+ " and is on sale now for "+ String.format(" %.2f ", t2.salePrice));
...
class GourmetTea2 extends Tea2
{
    ...
    GourmetTea2( int teaId, String teaType, String teaName, String gourmetBrand, double teaPrice)
    {
        this.teaId= teaId;
        this.teaType= teaType;
        this.teaName= teaName;
